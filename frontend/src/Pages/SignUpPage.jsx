	...
	return ( 
		...
		<div className='min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 dark:bg-gray-900'>
			<div className='sm:mx-auto sm:w-full sm:max-w-md'>
				<img className='mx-auto h-36 w-auto' src='ApsitINlogo.avif' alt='APSIT-In' />
					...
					<div className='mt-6'>
						<div className='relative'>
							...
							<div className='relative flex justify-center text-sm'>
								<span className='px-2 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400'>Already on APSIT-In</span>
							</div>
						</div>
						<div className='mt-6'>
							<Link
